<template>
    <transition name="move">
        ...
        <!-- 父组件food监听子组件cartcontrol的add派生事件，一旦add触发，就会触发父组件food中的addFood方法 -->
                ...
                <div class="info" v-show="food.info">
                    ...
                    <p class="info-detail">{{food.info}}</p>
                </div>
                <split></split>
                <div class="ratings">
                    <h1 class="title">商品评价</h1>
                    <ratingselect @select="selectRating" @toggleContent="toggleContent" :selectType="selectType"
    ...
    .food
        ...
        .food-content
            .image-header
                ...
                width 100%
                height 0
                padding-top 100%  //padding设为100%时，相当于宽高相等的容器
                img
                    position absolute
                    left 0
                    top 0
                    width 100%
                    height 100%  //把容器高度宽度撑开
                .back
                    position absolute
                    top 10px
                    left 0
